#ifndef __TCP_MAKE_OBJECT_H_INCLUDED__
#define __TCP_MAKE_OBJECT_H_INCLUDED__
...
#pragma warning(disable:4348) //C4348 переопределение параметра по умолчанию
      ...
      boost::shared_ptr< _Interface > make_shared_pool_enable2( Args&& ... args ) {
         ...
         static _Pool pool;
         return boost::allocate_shared< enable_make< _Class > >( pool, std::forward< Args >( args ) ... );
      }
#pragma warning(default:4348)
...
#pragma warning(disable:4348) //C4348 переопределение параметра по умолчанию
      ...
      boost::shared_ptr< _Class > make_shared_pool2( Args&& ... args ) {
         static _Pool pool;
         return boost::allocate_shared< _Class >( pool, std::forward< Args >( args ) ... );
      }
#pragma warning(default:4348)
   }
}
...
#endif //__TCP_MAKE_OBJECT_H_INCLUDED__
