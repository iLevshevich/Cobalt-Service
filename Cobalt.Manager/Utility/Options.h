#ifndef __MANAGER_OPTIONS_H_INCLUDED__
#define __MANAGER_OPTIONS_H_INCLUDED__
...
namespace Cobalt
{
   namespace Utility
   {
      ...
      public:
         ...
         inline std::string __fastcall get( const std::string& key ) const;
...
#endif //__MANAGER_OPTIONS_H_INCLUDED__
