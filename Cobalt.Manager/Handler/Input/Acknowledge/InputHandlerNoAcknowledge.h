#ifndef __MANAGER_INPUT_HANDLER_NO_ACKNOWLEDGE_TYPE_H_INCLUDED__
#define __MANAGER_INPUT_HANDLER_NO_ACKNOWLEDGE_TYPE_H_INCLUDED__
      ...
      namespace Input
      {
         ...
         public:
            ...
            virtual void __stdcall consume( consumer_type consumer,
               ...
               consumer->consumeNoAck( executor, routingKey );
            }

            virtual ~InputHandlerNoAcknowledge() = default;
         };
      }
   }
}
...
#endif //__MANAGER_INPUT_HANDLER_NO_ACKNOWLEDGE_TYPE_H_INCLUDED__
