#ifndef __MANAGER_OUTPUT_HANDLER_NO_ACKNOWLEDGE_TYPE_H_INCLUDED__
#define __MANAGER_OUTPUT_HANDLER_NO_ACKNOWLEDGE_TYPE_H_INCLUDED__
      ...
      namespace Output
      {
         ...
         public:
            ...
            virtual void __stdcall publish( publisher_type publisher,
               ...
               publisher->publishNoAck( executor, routingKey );
            }
            ...
            virtual ~OutputHandlerNoAcknowledge() = default;
         };
      }
   }
}
...
#endif //__MANAGER_OUTPUT_HANDLER_NO_ACKNOWLEDGE_TYPE_H_INCLUDED__
