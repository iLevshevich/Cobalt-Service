#ifndef __MANAGER_TCP_TO_TCP_DISPATCHER_HANDLER_H_INCLUDED__
#define __MANAGER_TCP_TO_TCP_DISPATCHER_HANDLER_H_INCLUDED__
   ...
   namespace Handler
   {
      namespace Dispatcher
      {
         ...
         public:
            ...
            typedef typename Utility::Traits< ITcpToTcpDispatcherHandlerBuilder< base_type > >::const_reference_t builder_type;
            ...
            virtual ~TcpToTcpDispatcherHandler() = default;

         protected:
            explicit TcpToTcpDispatcherHandler( builder_type input_builder );
...
#endif //__MANAGER_TCP_TO_TCP_DISPATCHER_HANDLER_H_INCLUDED__
