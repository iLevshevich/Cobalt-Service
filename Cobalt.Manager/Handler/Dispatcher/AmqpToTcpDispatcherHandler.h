#ifndef __MANAGER_AMQP_TO_TCP_DISPATCHER_HANDLER_H_INCLUDED__
#define __MANAGER_AMQP_TO_TCP_DISPATCHER_HANDLER_H_INCLUDED__
   ...
   namespace Handler
   {
      namespace Dispatcher
      {
         ...
         public:
            ...
            typedef typename Utility::Traits< IAmqpToTcpDispatcherHandlerBuilder< base_type > >::const_reference_t builder_type;
            ...
            virtual ~AmqpToTcpDispatcherHandler() = default;

         protected:
            explicit AmqpToTcpDispatcherHandler( builder_type input_builder );
...
#endif //__MANAGER_AMQP_TO_TCP_DISPATCHER_HANDLER_H_INCLUDED__
