#ifndef __MANAGER_I_TCP_TO_TCP_DISPATCHER_HANDLER_BUILDER_H_INCLUDED__
#define __MANAGER_I_TCP_TO_TCP_DISPATCHER_HANDLER_BUILDER_H_INCLUDED__
   ...
   namespace Handler
   {
      namespace Dispatcher
      {
         ...
         public:
            ...
            virtual ITcpToTcpDispatcherHandlerBuilder< T >& __fastcall setState(state_type f) = 0;
            virtual ITcpToTcpDispatcherHandlerBuilder< T >& __fastcall setMeta(meta_type f) = 0;
            virtual boost::shared_ptr< state_base_type > getState() const = 0;
            virtual boost::shared_ptr< meta_base_type > getMeta() const = 0;

            virtual ITcpToTcpDispatcherHandlerBuilder< T >& __fastcall setInputFactory(input_factory_type f) = 0;
            virtual ITcpToTcpDispatcherHandlerBuilder< T >& __fastcall setInputSettings(input_settings_type f) = 0;
            ...
            virtual ITcpToTcpDispatcherHandlerBuilder< T >& __fastcall setOutputFactory(output_factory_type f) = 0;
            virtual ITcpToTcpDispatcherHandlerBuilder< T >& __fastcall setOutputSettings(output_settings_type f) = 0;
            ...
            virtual ~ITcpToTcpDispatcherHandlerBuilder() = default;
         };
      }
   }
}
...
#endif //__MANAGER_I_TCP_TO_TCP_DISPATCHER_HANDLER_BUILDER_H_INCLUDED__
